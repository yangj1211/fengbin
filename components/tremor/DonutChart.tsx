...
// Modified for React 19 / Recharts 3.8: preserve controlled click selection
// with a custom sector shape in place of the removed Pie activeIndex prop.
// Original implementation is Apache-2.0.
      ...
      >
        ...
        >
          ...
          >
            ...
            <Pie
              className={cx(
                'stroke-[var(--dashboard-surface)] [&_.recharts-pie-sector]:outline-hidden',
              ...
              shape={(shapeProps, sectorIndex) =>
                renderInactiveShape({
                  ...shapeProps,
                  opacity:
                    activeIndex === undefined || activeIndex === sectorIndex
                      ? 1
                      : 0.3,
                })
              }
