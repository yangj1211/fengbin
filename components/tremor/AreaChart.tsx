...
const AreaChart = React.forwardRef<HTMLDivElement, AreaChartProps>(
  (props, ref) => {
    ...
    // Keep isolated points and all-zero series visible without inventing values.
    ...
    const visibleValues = [...valuesByCategory.values()].flat();
    const allZero =
      visibleValues.length > 0 && visibleValues.every((value) => value === 0);
    const dotCategories = new Set(
                ...
                const cleanPayload: TooltipProps['payload'] = payload
                  ? payload
                      ...
                      .map((item: any) => ({
                        ...
                        value: item.value,
                        index: String(item.payload?.[index] ?? label),
